...
namespace SCRA {
	...
	public abstract class Robot : MonoBehaviour {
		...
		/// </summary>
		[SerializeField]
		protected float mForwardInput, mRotateInput, mJumpInput;                                    
		/// <summary>
		...
		/// Vertical velocity
		/// </summary>
		protected float mVerticalVel;
		/// <summary>
		/// Input variables
		/// </summary>
		protected float mVOrbitInput, mHOrbitInput, mOrbitSnapInput;

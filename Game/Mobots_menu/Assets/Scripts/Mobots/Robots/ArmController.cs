...
namespace Mobots.Robots {
	...
	public class ArmController : MonoBehaviour {
		...
		void Turn() {
			...
			this.mLeftArm.localRotation = Quaternion.Euler(Camera.main.transform.rotation.x + this.mOrbit.mXRotation,
				mOrbit.mYRotation, 0);
			this.mRightArm.localRotation = Quaternion.Euler(Camera.main.transform.rotation.x + this.mOrbit.mXRotation,
				-mOrbit.mYRotation, 0);
		}
	}
}
